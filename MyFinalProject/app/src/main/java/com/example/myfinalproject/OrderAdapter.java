...
import com.example.myfinalproject.DetailCartActivity;
import com.example.myfinalproject.Pesanan;
...
public class OrderAdapter extends FirestoreRecyclerAdapter<Pesanan, OrderAdapter.ViewHoler> {
     ...
     * @param options
     */
    public OrderAdapter(@NonNull FirestoreRecyclerOptions<Pesanan> options) {
        super(options);
    }
    ...
    @Override
    protected void onBindViewHolder(@NonNull OrderAdapter.ViewHoler holder, int position, @NonNull Pesanan model) {
    ...
    @NonNull
    @Override
    public OrderAdapter.ViewHoler onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
