        ...
        Login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(username) || TextUtils.isEmpty(pass)) {
                    Toast.makeText(student_login.this, "Input username and password", Toast.LENGTH_SHORT).show();
                }else {
        ...
        auth.signInWithEmailAndPassword(username, pass).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()){
                    ...
                    task.getException();
                    Intent intent = new Intent(student_login.this, ProductActivity.class);
